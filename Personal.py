...
class Empleado(Gerente):
    def __init__(self, Nombre, Altura, Vestimenta):
        ...
        self.__Nombre = Nombre
    def status(self):
        print("El empleado de la empresa es un empleado que mide ", self.__Altura, "mts")
        print("Se llama ", self.__Nombre, "y tiene", self.__Vestimenta)
    def Trabajanto(self):
...
class Persona(Gerente):
    ...
    def getInfo(self):
        super().getInfo()
    def status(self):
        print("La persona va a solicitar empleo a la empresa, es una persona que mide ", self.__Altura, "mts")
        print("Se llama ", self.__Nombre, "y tiene", self.__Vestimenta)
